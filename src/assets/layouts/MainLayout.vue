<template>
  <div>
    ...
    <!-- Render the current view within the main layout -->
    <router-view />
  ...
  // Import JS libraries only for MainLayout
  import 'bootstrap/dist/js/bootstrap.bundle.min.js';
  import Swiper from 'swiper/bundle';
  import GLightbox from 'glightbox';
  import AOS from 'aos';
  
  // Initialize libraries specific to MainLayout
  AOS.init();
  GLightbox();
  ...
  export default {
    ...
    mounted() {
      // Initialize Swiper only when MainLayout is mounted
